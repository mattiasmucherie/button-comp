...
const Button = (props: ButtonProps): JSX.Element => {
  const { onClick, disabled, color, text, startIcon, endIcon, variant, disableShadow, size } = props
  ...
  const renderText = (buttonText: string = "Default", start?: string, end?: string) => {
    if (start) {
      return (
        <>
